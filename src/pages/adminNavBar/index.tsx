          ...
          <div className="flex flex-col h-full">
            <div className='h-24 flex items-center px-12'>
              <Link href="/dashboard" className="text-2xl font-bold">
                <Image src={'/img/logo5.png'} width={140} height={100} alt="" />
              </Link>              
            </div>
              ...
              <ul className="px-4 text-xl font-medium flex-1">
                {
                  navigation.map((item, idx) => (
                    <li key={idx}>
                      <Link href={item.href} className="flex items-center gap-x-5 text-white px-9 py-4 rounded-lg hover:bg-yellow-500 duration-100">
              ...
              <div>
                ...
                <div className="py-5 px-7 border-t">
                  <div className="flex items-center gap-x-4">
                    <Image src={'/img/RAGLogoWhite.png'} className="w-14 h-14 rounded-full" alt='' width={25} height={25} quality={100} />
                    <div>
