...
import { faEnvelope, faEye, faEyeSlash, faKey, faLock, faSignature, faUser } from '@fortawesome/free-solid-svg-icons';
        ...
        <>
            <main className="w-full flex">
                <div className="relative flex-1 hidden items-center justify-center h-screen bg-gray-900 lg:flex">
                    <div className="relative z-10 w-full max-w-md text-center">
                        <div className="mt-16 space-y-6">
                            <NeonText texto='¡Bienvenido a la' neonColor={NeonColors.sky} neonSecondary={NeonColors.sky} size='5xl' />
                            <NeonText texto='Tienda RAG!' neonColor={NeonColors.pink} neonSecondary={NeonColors.pink} size='5xl' />
                            <p className="text-gray-300">
                                Descubre las últimas tendencias, encuentra estilos únicos y eleva tu moda con RAG. Crea una cuenta y desbloquea un mundo de ofertas exclusivas y experiencias de compra personalizadas.
                            </p>
                ...
                <div className="flex-1 flex items-center justify-center h-screen bg-gray-100">
                    <div className="w-full max-w-md bg-white rounded-lg border shadow-lg p-8 py-16 space-y-8 text-black">
                        ...
                        {/* BOTONES FACHEROS DE GOOGLE, GITHUB Y TWITER */}
                        {/*
                        ...
                        */}
                        <form onSubmit={handleRegister} className="space-y-5">
                            ...
                            <button type="submit" className="w-full px-4 py-2 text-white font-medium bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-600 rounded-lg duration-150" disabled={loading}
                            >
                                Registrarme
                            </button>
                        </form>
